...
function HomeScreen({ navigation }) {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Prova Fausto</Text>
      <Text style={styles.subtitle}>Guilherme borges rocha</Text>
...
function InternetImageScreen({ navigation }) {
  ...
  <View style={[styles.container, { backgroundColor: '#6dbd23ff', justifyContent: 'center', alignItems: 'center' }]}>
      <Text style={styles.title}>Botao 2</Text>
...
function LocalImageScreen({ navigation }) {
  return (
      <View style={[styles.container, { backgroundColor: '#22dac5ff', justifyContent: 'center', alignItems: 'center' }]}>

      <Text style={styles.title}>Botao 3</Text>
      <Image
...
function IconsRowScreen({ navigation }) {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Botao 4</Text>

      <View style={styles.iconsRow}>
        <Ionicons name="home" size={48} color="#513da1ff" />       {/* azul */}
        <MaterialIcons name="favorite" size={48} color="#d0ff00ff" /> {/* vermelho */}
